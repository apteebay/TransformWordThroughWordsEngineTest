...
namespace Core
{
  ...
  [System.Diagnostics.DebuggerNonUserCode]
		...
		public partial class SerializationInfo
		{
			...
			// For some reason the Microsoft DataContract adds extra
			// letters to the end of the Data Contract name.
			// In this case it seems to add #"OzoZvLrm"
			[DataContract(Name="SerializationInfo.FieldDataOzoZvLrm")]
#else
			[DataContract]
#endif
