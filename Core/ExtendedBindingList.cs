...
extern alias Unimet;
using SerializationLib = Unimet::System.Runtime.Serialization;
#else
using SerializationLib = System.Runtime.Serialization;
#endif
using System;
...
#if !DESIGN
        [SerializationLib.OnDeserialized()]
#endif
